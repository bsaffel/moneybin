...
> rejected exactly that. As a current runtime invariant, eight SQLMesh report views back nine report routes:
...
- `raw`/`prep` CRITICAL columns are declared (D4) — 33 columns across 16
