...
- **Regression**: existing fast tools (e.g., `accounts`, `reports(report_id="core:spending_trend", parameters={...})`) complete unchanged and well under the cap on the standard test fixture.
