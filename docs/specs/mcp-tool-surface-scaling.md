...
contains 50 tools, 60,052 bytes of serialized metadata, zero advertised output schemas,
and registry SHA-256
`a0e38f22dfaad984fd7f8645667cc5314942e7b5a440f648781fbbd596daf01c`.
The frozen baseline is 90,734 bytes with SHA-256
`ea87a21b01e0f5181b80cef120beef2e9f46b31df121c7941329d9c493b48f79`.
The delta is -30,682 bytes (-33.8%). The deterministic estimate is 15,013
