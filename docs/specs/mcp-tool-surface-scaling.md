...
contains 50 tools, 64,284 bytes of serialized metadata, zero advertised output schemas,
and registry SHA-256
`04dff3f4936dfd22c3dd1b6d9c47288d2e04f58b67d0c7ec22460fa3883c55d1`.
The frozen baseline is 90,839 bytes with SHA-256
`b789459f13f3e7e5caa476ca7d4d1e2fa4f19f9b107bc93f2edbceeeb2abe7a7`.
The delta is -26,555 bytes (-29.2%). The deterministic estimate is 16,071
