...
flowchart TD
    ...
    GUARD -- fail --> BR
    HEAL --> HGATE{Fresh recipe reconciles AND sign convention unchanged?}
    HGATE -- yes --> BUMP[bump_version: repair the saved recipe] --> T
    HGATE -- no --> BR
