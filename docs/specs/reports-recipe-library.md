...
The current catalog has since grown: nine SQLMesh report views back nine report
...
slice. `reports.net_worth_accounts`, specified by
[`reports-net-worth-sql-surface.md`](reports-net-worth-sql-surface.md), has no
