...
The elicitation helper is shared, not per-tool: `moneybin/mcp/elicitation.py::supports_elicitation` (the capability probe) backs both this gate and the first-run profile bootstrap (`mcp/first_run.py`).
