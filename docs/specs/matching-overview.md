...
- **Same-record Match for investment events** — specified by
  [M1J.7 Investment Event Matching](investment-event-matching.md), which
  refines this broad deferral. Derived lots and holdings are rebuilt from the
  Golden ledger rather than matched directly.
