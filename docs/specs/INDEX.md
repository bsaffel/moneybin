...
| [E2E Testing](e2e-testing.md) | Feature | in-progress | Subprocess-based E2E tests: smoke tests (help, no-DB, DB commands), golden-path workflow tests (synthetic, CSV, OFX, lock/unlock, categorization) |
