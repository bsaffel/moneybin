...
| [User-Facing Doc Polish](user-facing-doc-polish.md) | Feature | ready | README rewrite, CHANGELOG backfill, threat-model guide, License section with substance, expanded comparison table, Wave-aligned roadmap. Tagline preserved; honesty layer below. Ships in batches: now (no product deps), Wave 2B (architecture distillation), Wave 2C (brew install + demo asset). |
