...
- **You need statement-proven realized FX gain/loss today.** Use [Firefly III](https://www.firefly-iii.org/) or [Beancount](https://beancount.github.io/). MoneyBin computes and reports realized gain/loss for each consumed Currency lot, but the deliberate EUR/USD bank-statement tie-out is still open.
