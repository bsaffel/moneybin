...
| **M1O** | [`moneybin export` bundle](specs/export.md) (CSV / Parquet / Excel / Google Sheets) | 📐 | Local files are the canonical exit path: manifest, checksums, generated data dictionary, timestamped immutable artifacts, and a separate managed-tab Sheets destination. |
