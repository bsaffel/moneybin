...
| **M2A–M2B** | Curated reports plus net-worth and balance tracking | 🚧 — M2A and M2B.1 shipped; M2B.2 in progress and gating Public Beta, with M2B.3's unanchored-account guard designed alongside it ([reports-net-worth-sql-surface.md](specs/reports-net-worth-sql-surface.md)) |
