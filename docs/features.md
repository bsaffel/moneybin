...
- **Canonical export delivery** — `moneybin export bundle` publishes a closed
  [portability catalog](guides/cli-reference.md#export) to redacted CSV by
  default under
