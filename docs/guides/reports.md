...
That build ends with a `Demo profile ready` receipt: 4 accounts saved, 2886 transactions saved, 2473 categorized, net worth 420,080.77, doctor clean — three calendar years ending on the last complete one, two bank accounts and two credit cards, seed 42. The seed fixes the figures within one calendar year: the window ends on the last complete year and `demo` has no option to pin it, so a rerun after January 1 shifts every date-bound number a year forward while the shapes hold.
...
│ 2025-09-01T00:00:00 │ USD      │ 390,658.51 │  +9,491.84 │ 2.49%      │
│ 2025-10-01T00:00:00 │ USD      │ 400,802.98 │ +10,144.47 │ 2.60%      │
│ 2025-11-01T00:00:00 │ USD      │ 410,815.53 │ +10,012.55 │ 2.50%      │
│ 2025-12-01T00:00:00 │ USD      │ 420,080.77 │  +9,265.24 │ 2.26%      │
└─────────────────────┴──────────┴────────────┴────────────┴────────────┘
› Run reports(report_id='core:networth') for a single-date account breakdown
› Rerun reports(report_id='core:networth_history', parameters={'from_date': 'YYYY-MM-DD', 'to_date':
'YYYY-MM-DD', 'interval': 'weekly'}) for finer resolution
```
