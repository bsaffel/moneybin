...
| **Power user setting up and running it daily** | [`guides/getting-started.md`](guides/getting-started.md) → [`guides/data-import.md`](guides/data-import.md) → [`guides/categorization.md`](guides/categorization.md) → [`guides/reports.md`](guides/reports.md) |
