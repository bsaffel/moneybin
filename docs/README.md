...
- **[Reports](guides/reports.md)** — The nine built-in reports with their real output, `--wide` and JSON, saving your own SQL as a report, and which reports `--display-currency` can price into one currency.
