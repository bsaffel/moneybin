...
def register_generic_reports_tool(mcp: FastMCP) -> None:
    ...
    register(
        ...
        "any converted figure, and `summary.home_currency` names the home "
        "currency actually priced into a home-basis column such as "
        "`net_worth_home`, absent when no conversion put a value in one. "
        "A report that cannot be priced stays segmented "
