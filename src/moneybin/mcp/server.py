...
mcp = FastMCP(
    ...
    instructions=textwrap.dedent(
        ...
        Sensitivity tiers low/medium/high are logged per call. Account and routing numbers are always masked before results leave this server; all other fields (amounts, descriptions, dates) reach the model provider as-is. There is no consent gate yet — treat any tool result as sent to the provider.
        """
    ),
