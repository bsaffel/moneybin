"""V038: add iso_currency_code to raw.plaid_balances.

Plaid's balance objects return iso_currency_code in the live API; it was
captured for transactions/securities/investment-transactions/holdings but
never wired into the balances path (multi-currency.md M1K.1 Requirement 1).
...
def migrate(conn: object) -> None:
    """Add raw.plaid_balances.iso_currency_code. Idempotent."""
