...
def execute(
    ...
    **kwargs: t.Any,
    ...
    yield pa.Table.from_pylist([asdict(row) for row in rows], schema=schema).to_pandas(  # pyright: ignore[reportUnknownMemberType]  # pyarrow-stubs types to_pandas's categories as a bare list
