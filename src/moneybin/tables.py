...
# The five core models flip to audience="interface" when their SQLMesh models
# + schema-catalog examples land (INTERFACE_TABLES is a live contract: the
# table must exist in the catalog DB and carry query examples).
...
DIM_SECURITIES = TableRef("core", "dim_securities")
FCT_INVESTMENT_TRANSACTIONS = TableRef("core", "fct_investment_transactions")
FCT_INVESTMENT_LOTS = TableRef("core", "fct_investment_lots")
FCT_REALIZED_GAINS = TableRef("core", "fct_realized_gains")
DIM_HOLDINGS = TableRef("core", "dim_holdings")
