...
not_implemented envelope shape — not real sync behavior. sync_pull and
sync_status have live implementations tested in test_mcp_sync.py.
...
async def test_sync_stub_tool_returns_not_implemented_envelope(
    ...
    assert parsed["error"]["details"]["spec"] == "docs/specs/2026-05-13-plaid-sync-design.md"
