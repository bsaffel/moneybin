...
sync_pull, sync_status, sync_connect, sync_connect_status, and sync_disconnect
have live implementations tested in test_mcp_sync.py. sync_login and sync_logout
are CLI-only (browser interaction + credential handling) and are intentionally
absent from MCP.
"""
