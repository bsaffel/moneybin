...
EXPECTED_INTERFACE = {
    ...
    BRIDGE_MERCHANT_ENTITIES.full_name,
    ...
    REPORTS_NET_WORTH_ACCOUNTS.full_name,
    REPORTS_NET_WORTH_CURRENCIES.full_name,
    ...
    DIM_HOLDINGS_BROKER_REPORTED.full_name,
    DIM_UNANCHORED_ACCOUNTS.full_name,
