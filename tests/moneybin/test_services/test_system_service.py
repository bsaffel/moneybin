...
@pytest.fixture()
def system_db(db: Database) -> Database:
    ...
    conn.execute("""
        ...
        ('ACC001', '111000025', 'CHECKING', 'Test Bank', 'test_bank', '1234', 'ofx',
         ...
         'Test Bank CHECKING ...0001', TRUE, NULL, NULL, NULL, NULL, 'USD', NULL, FALSE, NULL, TRUE),
        ('ACC002', '222000050', 'SAVINGS', 'Other Bank', 'other_bank', '5678', 'ofx',
         'other.qfx', '2025-01-01', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
         'Other Bank SAVINGS ...0002', TRUE, NULL, NULL, NULL, NULL, 'USD', NULL, FALSE, NULL, TRUE)
    """)  # test input, not executing SQL
...
@pytest.mark.unit
def test_status_date_range_empty_db(db: Database) -> None:
