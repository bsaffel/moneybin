...
def _seed_fct_balances_daily(
    ...
    Bypasses SQLMesh for unit-test speed. The schema mirrors the SQLMesh
    Python model output (see sqlmesh/models/core/fct_balances_daily.py).
    """
    db.execute(
        """
...
class TestAssertionsCRUD:
    ...
    @pytest.mark.unit
    def test_delete_removes(self, test_db: Database) -> None:
        svc = BalanceService(test_db)
        svc.assert_balance("acct_a", date(2026, 1, 31), Decimal("100.00"))
    ...
    @pytest.mark.unit
    def test_delete_silent_on_missing(self, test_db: Database) -> None:
        svc = BalanceService(test_db)
        svc.delete_assertion("acct_a", date(2099, 1, 1))  # no error

    @pytest.mark.unit
    def test_list_filters_by_account(self, test_db: Database) -> None:
        svc = BalanceService(test_db)
        svc.assert_balance("acct_a", date(2026, 1, 31), Decimal("100.00"))
    ...
    @pytest.mark.unit
    def test_list_all_assertions(self, test_db: Database) -> None:
        svc = BalanceService(test_db)
        svc.assert_balance("acct_a", date(2026, 1, 31), Decimal("100.00"))
        svc.assert_balance("acct_b", date(2026, 1, 31), Decimal("200.00"))
...
class TestCurrentBalances:
    ...
    @pytest.mark.unit
    def test_current_returns_latest_per_account(self, test_db: Database) -> None:
    ...
    @pytest.mark.unit
    def test_current_filters_by_account(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
    ...
    @pytest.mark.unit
    def test_current_as_of_date(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
...
class TestHistory:
    ...
    @pytest.mark.unit
    def test_history_returns_full_series(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
    ...
    @pytest.mark.unit
    def test_history_date_range(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
...
class TestReconcile:
    ...
    @pytest.mark.unit
    def test_reconcile_returns_nonzero_deltas(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
    ...
    @pytest.mark.unit
    def test_reconcile_threshold(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
    ...
    @pytest.mark.unit
    def test_reconcile_filter_by_account(self, test_db: Database) -> None:
        _seed_fct_balances_daily(
            test_db,
            [
                {
