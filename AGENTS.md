...
| `branching.md` | Branch prefix → PR label mapping, commit message style; what you publish is a public surface — never put real account data in a branch name, commit message, or PR body |
